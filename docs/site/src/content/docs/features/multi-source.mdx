...
Press <kbd>f</kbd> to cycle through scopes, or click a filter button.
...
| <kbd>f</kbd> | Cycle scope filter (Today → Week → Month → Inbox → All) |
| <kbd>Enter</kbd> | Open selected source from dashboard |
