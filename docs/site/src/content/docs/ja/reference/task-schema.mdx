...
<Aside type="tip">
このページは英語版から自動生成されたものです（commit [`07ed165`](https://github.com/ywh555hhh/Mutsumi/commit/07ed165)）。翻訳が遅れている場合があります。正確な情報は [English 版](/reference/task-schema/) をご参照ください。
</Aside>
