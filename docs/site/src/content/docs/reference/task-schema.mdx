...
Tags are displayed in the task row (space permitting) and are searchable via the <kbd>/</kbd> search bar.
...
Displayed in the detail panel (press <kbd>Enter</kbd> to expand).
