...
{/* AUTO-GENERATED from commit 07ed165 — DO NOT EDIT. Run: uv run python scripts/gen_docs.py */}

import { Aside } from '@astrojs/starlight/components';

<Aside type="tip">
This page is auto-generated from source code (commit [`07ed165`](https://github.com/ywh555hhh/Mutsumi/commit/07ed165)). Do not edit manually — run `uv run python scripts/gen_docs.py` to regenerate.
</Aside>
