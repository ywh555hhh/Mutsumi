...
{/* AUTO-GENERATED from commit fc98d58 — DO NOT EDIT. Run: uv run python scripts/gen_docs.py */}

import { Aside } from '@astrojs/starlight/components';

<Aside type="tip">
This page is auto-generated from source code (commit [`fc98d58`](https://github.com/ywh555hhh/Mutsumi/commit/fc98d58)). Do not edit manually — run `uv run python scripts/gen_docs.py` to regenerate.
</Aside>
