...
<Tabs>
  <TabItem label="Windows">
    ...
    - <kbd>Alt+Shift+D</kbd> — auto-split (duplicate current pane)
    - <kbd>Alt+Shift+=</kbd> — split vertically
    - <kbd>Alt+Shift+-</kbd> — split horizontally
    - <kbd>Alt+Arrow keys</kbd> — switch between panes

    Workflow:
    1. Open your project directory
    2. <kbd>Alt+Shift+=</kbd> to split vertically
    3. In the right pane, type `mutsumi`
    4. <kbd>Alt+←</kbd> to switch back to the left pane, start your agent
...
4. **Toggle tasks** — click checkboxes or press <kbd>x</kbd> in Mutsumi to mark done

5. **Switch projects** — `mu ~/projects/other-app` opens a new tmux session; switch between them with <kbd>Ctrl-b s</kbd>

6. **Detach** — <kbd>Ctrl-b d</kbd> to detach; the session keeps running. Come back anytime with `mu`
...
| tmux pane too narrow for Mutsumi | `export MUTSUMI_WIDTH=40` or resize with <kbd>Ctrl-b →</kbd> |
