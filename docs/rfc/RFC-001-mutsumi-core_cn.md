...
> **历史说明（2026-03-24）：** 本 RFC 记录的是 Mutsumi 最早期的架构方向。文中部分细节已经不再代表当前产品基线。关于当前规范行为，请优先参考 `README.md`、`docs/specs/*.md`、`docs/ROADMAP.md` 以及更新的 RFC（如 RFC-006、RFC-007、RFC-008、RFC-009）。
